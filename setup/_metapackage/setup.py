...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-purchase_order_revision>=16.0dev,<16.1dev',
        ...
        'odoo-addon-purchase_stock_cost_update>=16.0dev,<16.1dev',
        ...
        'odoo-addon-purchase_uninvoiced_amount_force_invoiced_line>=16.0dev,<16.1dev',
